export default function LandingPage() {
  ...
  return (
    <div style={{ background: '#000', minHeight: '100vh', color: '#fff' }}>
      ...
      <header style={{ padding: '16px 20px', borderBottom: '1px solid #222', maxWidth: '1000px', margin: '0 auto' }}>
      ...
      <section style={{ padding: '60px 20px', textAlign: 'center', maxWidth: '800px', margin: '0 auto' }}>
        <h1 style={{ fontSize: 'clamp(24px, 5vw, 40px)', fontWeight: 700, lineHeight: 1.3, marginBottom: '32px' }}>
          I'll Show You How To Scale A Home Service Business to{' '}
          <span style={{ color: '#22c55e' }}>$1,000 Per Day In Profit</span>... Or You Don't Pay
        </h1>
        ...
        <div style={{ position: 'relative', paddingBottom: '56.25%', marginBottom: '40px', borderRadius: '8px', overflow: 'hidden', border: '1px solid #333' }}>
          <iframe
      ...
      <section style={{ padding: '60px 20px', maxWidth: '800px', margin: '0 auto' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
          {testimonialVideos.map((videoId, i) => (
            <div key={i} style={{ position: 'relative', paddingBottom: '56.25%', borderRadius: '8px', overflow: 'hidden', border: '1px solid #333' }}>
              <iframe
